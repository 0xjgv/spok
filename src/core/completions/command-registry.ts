...
/**
 * Registry of all Spok CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env SPOK_CONCURRENCY or 6)',
        takesValue: true,
      },
    ...
    subcommands: [
      {
        ...
        flags: [
          ...
          {
            name: 'tools',
            description: 'Install Spok skills for agents (all, none, or comma-separated tool IDs)',
            takesValue: true,
          },
          COMMON_FLAGS.json,
          COMMON_FLAGS.noInteractive,
  ...
  {
    name: 'change',
    description: 'Manage Spok change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage Spok specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
