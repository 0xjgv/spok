...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'spok';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/spok/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/spok/
 * - Windows fallback: %APPDATA%/spok/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/spok/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/spok/
 * - Windows fallback: %LOCALAPPDATA%/spok/
 */
