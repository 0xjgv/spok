...
export function suggestSchemas(
  ...
  let message = `Schema '${invalidSchemaName}' not found in spok/config.yaml\n\n`;
  ...
  message += `\nFix: Edit spok/config.yaml and change 'schema: ${invalidSchemaName}' to a valid schema name`;
