...
1. **Get active changes**
   ...
   Run \`spok list --json\` to get all active changes.
...
3. **Batch validation - gather status for all selected changes**
   ...
   a. **Artifact status** - Run \`spok status --change "<name>" --json\`
...
8. **Execute archive for each confirmed change**
   ...
   a. **Sync specs** if delta specs exist:
      - Use the spok-sync-specs approach (agent-driven intelligent merge)
...
- Preserve .spok.yaml when moving to archive
