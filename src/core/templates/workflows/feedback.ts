...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Spok with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Spok.
...
5. **Submit on confirmation**
   - Use the \`spok feedback\` command to submit
   - Format: \`spok feedback "title" --body "body content"\`
