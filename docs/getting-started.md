...
This guide explains how Spok works after you've installed and initialized it. For installation instructions, see the [main README](../README.md#quick-start).

## How It Works

Spok helps you and your AI coding assistant agree on what to build before any code is written.
...
The default global profile is `core`, which includes `propose`, `explore`, `apply`, `sync`, and `archive`. You can enable the expanded workflow commands with `spok config profile` and then `spok update`.
...
Delta specs are the key concept in Spok. They show what's changing relative to your current specs.
...
The change folder moves to `spok/changes/archive/` for audit history.
...
AI:  Archiving add-dark-mode...
     ✓ Merged specs into spok/specs/ui/spec.md
...
- [Customization](customization.md) - Make Spok work your way
