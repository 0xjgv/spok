...
describe('interactive utilities', () => {
  let originalSpokInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalSpokInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalSpokInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalSpokInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
